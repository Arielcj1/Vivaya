...
Cypress.on('uncaught:exception', (err, runnable) => {
  ...
  describe('Web Page for Guest', ()=>{
    ...
    it('Book a Free public Event from Dashboard', ()=>{
        ...
        dashboard.free_Event_Confirmation('Guest', 'User', 'guest15@user.com')
        cy.wait(3000)
    ...
    it('Verify the Guest creation in admin',()=>{
      ...
      guestPage.make_a_Search_by_email('guest15@user.com')
    ...
    it('Convert a Guest user to Seeker user',()=>{
      ...
      seekerCreation.type_Seeker_Email('guest15@user.com')
