    ...
    context('Iphone 12Pro resolution', () => {
        ...
        it('Verify Elements in Guide Dashboard after Login', ()=>{
            ...
            cy.get('#header').should('contain.html', 'user-item')
             ...
             cy.get(':nth-child(4) > .col-sm-4 > a').should('be.visible').and('have.text', 'Contact VIVAYA')
        ...
        it('Verify quick link redirections in Guide Dashboard after Login', ()=>{  
          ...
          cy.get(':nth-child(3) > .col-sm-8 > h3').should('be.visible').and('have.text','About me')
          cy.get('#guideapplicationstep4-about_me').should('be.visible')
          cy.get(':nth-child(5) > .col-sm-8 > h3').should('be.visible').and('have.text','Your Personal Mantra')
          cy.get('#guideapplicationstep4-mantra').should('be.visible')
          cy.get(':nth-child(7) > .col-sm-8 > h3').should('be.visible').and('have.text','Your Headshot')
          cy.get('#profile-form > :nth-child(8)').should('be.visible')
          cy.get('.img-circle').should('be.visible')
          cy.get(':nth-child(10) > .col-sm-8 > h3').should('be.visible').and('have.text','Your Philosophy')
          cy.get('#guideapplicationstep4-philosophy').should('be.visible')
          cy.get(':nth-child(12) > .col-sm-8 > h3').should('be.visible').and('have.text','Social Media')
