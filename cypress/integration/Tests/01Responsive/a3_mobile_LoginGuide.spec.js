    ...
    context('Iphone 12Pro resolution', () => {
        ...
        it('Verify Elements in Guide Dashboard after Login', ()=>{
            ...
            cy.get('#header').should('contain.html', 'user-item')
             ...
             cy.get(':nth-child(5) > .btn').and('have.text', 'Set 1-1 Availability')
             cy.get(':nth-child(6) > .btn').and('have.text', 'Set 1-1 Offerings')
             //cy.get(':nth-child(4) > .btn').should('be.visible').and('have.text', 'Add Seminar')
             cy.get(':nth-child(3) > :nth-child(2) > .btn').should('be.visible').and('have.text', 'Add Class')
             cy.get('.quick-links > h3').scrollIntoView()
             cy.get(':nth-child(7) > h3').should('be.visible').and('have.text', 'Your Seminars:')
        ...
        it('Verify quick link redirections in Guide Dashboard after Login', ()=>{  
          ...
          cy.get('.m80b').should('have.text', 'Events History & Recordings')
          cy.go('back')
          ...
          cy.get(':nth-child(4) > .col-md-12 > h2.text-center').and('have.text','My Philosophy')
