...
Cypress.on('uncaught:exception', (err, runnable) => {
  ...
  describe('Verify Buttons for "Sign In" ', ()=>{
    ...
    it('Verify the Button of "Sign In with google"',()=>{
        cy.get(':nth-child(1) > .auth-link > .auth-icon').should('be.visible')
        
        
    })

    it('Verify the Button of "Sign In with Facebook"',()=>{
        cy.get(':nth-child(2) > .auth-link > .auth-icon').should('be.visible')
        
    })

    it('Verify the Button of "Sign In with Apple"',()=>{
